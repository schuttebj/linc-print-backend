...
class Settings(BaseSettings):
    ...
    ALLOWED_ORIGINS: str = "https://linc-print-frontend-omp9gcyth-schuttebjs-projects.vercel.app,https://linc-print-frontend.vercel.app,http://localhost:3000,http://localhost:5173"
    ALLOWED_HOSTS: str = "*"
